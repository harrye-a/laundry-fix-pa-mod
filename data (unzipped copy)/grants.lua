...
function CreateBootstrapGrants()
	...
	Objective.RequireEitherRoom		( "PaddedHoldingCell", "HoldingCell", true )
...
function CreatePrisonerVisitationGrant()
    ...
    Objective.SetParent             ( "Grant_Visitation" )
    Objective.RequireObjectsWithAlt ( "VisitorTable", 3, "VisitorTableSecure" )
    ...
    Objective.SetParent             ( "Grant_Visitation" )
    Objective.RequireObjectsWithAlt ( "Tv", 2, "LargeTv" )
...
function CreateAdvancedSecurityGrant()
    ...
    Objective.SetParent             ( "Grant_AdvancedSecurity" )
    Objective.RequireObjectsWithAlt ( "Cctv", 6, "CctvCamo", "AdvancedSearchLight" )    
end
